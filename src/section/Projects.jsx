...
const projects = [
  {
    ...
    description:
      "Designed and developed a responsive personal portfolio website showcasing projects, skills, and experience. Features smooth scroll-triggered animations, interactive UI, and a functional contact form for direct communication. Optimized for performance and accessibility across all devices.",
    tech: [
      "React.js",
      "Tailwind CSS",
      "Framer-Motion",
  ...
  },
  {
    ...
    image: proxyImage,
    description:
      "A lightweight proxy server handling HTTP/HTTPS requests, with SSL/TLS support, request logging, and configurable ports, implemented for both Linux and Windows.",
    tech: [
      "C",
      "Socket Programming",
      "File Operations",
  ...
  },
  {
    ...
    description:
      "Built a terminal-based file manager with a color-coded interface to navigate, search, and manage files and directories. Included features like file operations (copy, move, delete), system information display, and search functionality, optimized for performance on both Windows and Linux environments.",
...
const Projects = () => {
  return (
    <section
      id="projects"
      className="relative min-h-screen flex flex-col items-center justify-center px-6 md:px-12 py-16 
    ...
    >
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
        {projects.map((project, index) => (
          <div
            key={index}
            className="project-card bg-[#1F2937]/50 border border-cyan-300/30 rounded-xl backdrop-blur-md p-6 transition-all duration-300 hover:scale-[1.02] hover:shadow-[0_0_30px_#ffffff] hover:border-white group bounce-element"
          >
            <img
              src={project.image}
